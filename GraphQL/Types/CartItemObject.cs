...
public sealed class CartItemObject : ObjectGraphType<CartItem>
{
    public CartItemObject()
    {
        ...
        Field(m => m.Book, type: typeof(BookObject)).Resolve(c => c.Source.Book).Description("Books per Cart Item");
